...
write.csv(pathogen_DRB1_1501, "./Python stuff/pathogen_DRB1_1501.csv", row.names = FALSE)
write.csv(IEDB_DRB1_1501, "./Python stuff/IEDB_DRB1_1501.csv", row.names = FALSE)

write.csv(pathogen_DRB1_0401, "./Python stuff/pathogen_DRB1_0401.csv", row.names = FALSE)
write.csv(IEDB_DRB1_0401, "./Python stuff/IEDB_DRB1_0401.csv", row.names = FALSE)

write.csv(pathogen_DRB5_0101, "./Python stuff/pathogen_DRB5_0101.csv", row.names = FALSE)
write.csv(IEDB_DRB5_0101, "./Python stuff/IEDB_DRB5_0101.csv", row.names = FALSE)
```
...
write.csv(all_similarities_significants, "./Python stuff/similarity_matrix.csv", row.names = FALSE)
```

### Viewing organisms most responsible:

```{r}
similarity_with_organism <- read_csv("./Data/similarity_matrix_with_organism.csv")

similarity_with_organism |>
