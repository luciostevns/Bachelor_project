...
write.csv(pathogen_DRB1_1501, "./Python stuff/Data/pathogen_DRB1_1501.csv", row.names = FALSE)
write.csv(IEDB_DRB1_1501, "./Python stuff/Data/IEDB_DRB1_1501.csv", row.names = FALSE)

write.csv(pathogen_DRB1_0401, "./Python stuff/Data/pathogen_DRB1_0401.csv", row.names = FALSE)
write.csv(IEDB_DRB1_0401, "./Python stuff/Data/IEDB_DRB1_0401.csv", row.names = FALSE)

write.csv(pathogen_DRB5_0101, "./Python stuff/Data/pathogen_DRB5_0101.csv", row.names = FALSE)
write.csv(IEDB_DRB5_0101, "./Python stuff/Data/IEDB_DRB5_0101.csv", row.names = FALSE)
```

### Displaying the python similarity method results:
...
all_sim <- read_csv("./Data/results/sim_finished.csv")
...
all_blosom_results <- all_blosom_results |>
  left_join(dplyr::select(autoimmune_data, Epitope_ID, Disease, Epitope_Protein),
            by = "Epitope_ID") |>
  unique()
